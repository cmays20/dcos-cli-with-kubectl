marathonpath=infra/network/dcos-edgelb
...
dcos security org service-accounts create -p public-${serviceaccount}.pem -d /${marathonpath} ${serviceaccount}
dcos security secrets delete /${marathonpath}/private-${serviceaccount}
dcos security secrets create-sa-secret --strict private-${serviceaccount}.pem ${serviceaccount} /${marathonpath}/private-${serviceaccount}

dcos security org users grant ${serviceaccount} dcos:secrets:default:/${marathonpath}/* full
dcos security org users grant ${serviceaccount} dcos:secrets:list:default:/${marathonpath} full
...
dcos security org users grant ${serviceaccount} dcos:service:marathon:marathon:services:/${marathonpath} full
...
dcos security org users grant ${serviceaccount} dcos:adminrouter:service:${marathonpath}/pools/all full
dcos security org users grant ${serviceaccount} dcos:adminrouter:service:${marathonpath}/pools/dklb full
